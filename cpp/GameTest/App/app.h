...
namespace App
{
	...
	//-------------------------------------------------------------------------------------------
	// void DrawCircle(float x, float y, float ra, float r = 1.0f, float g = 1.0f, float b = 1.0f)
	//-------------------------------------------------------------------------------------------
	// Draw a cirlce with center located at x,y with radius ra using color r = red, g = green, b=blue.
	//-------------------------------------------------------------------------------------------
	void DrawCircle(float x, float y, float ra, float r = 1.0f, float g = 1.0f, float b = 1.0f);
	...
	//-------------------------------------------------------------------------------------------
	// Draw a rectangle from (x, y) to (x + width, y + height) with radius ra using color r = red, g = green, b=blue.
	//-------------------------------------------------------------------------------------------
	void DrawRectangle(float x, float y, float width, float height, float r = 1.0f, float g = 1.0f, float b = 1.0f);
